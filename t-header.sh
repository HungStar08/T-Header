...
if [[ ${#PROC} -gt 8 ]]; then
	...
	echo ""
	echo -e "\033[32mPlease Enter Less Than \033[33m9 \033[32mcharacters Name\033[0m" | pv -qL 10;
	echo ""
	sleep 4
	clear
echo -e "\033[01;32m
...
echo "";
echo -e "
\033[0;31m┌─[\033[1;34m$TNAME\033[1;33m  \033[1;36mHacker \033[0;31m]─[\033[0;32m~${PWD/#"$HOME"}\033[0;31m]
...
PROMPT=$'
%{\e[0;31m%}┌─[ %{\e[1;34m%}%B%{\${TNAME}%}%{\e[1;33m%} %{\e[1;36m%}Hacker %b%{\e[0;31m%}]─[%{\e[0;32m%}%(4~|/%2~|%~)%{\e[0;31m%}]%b
